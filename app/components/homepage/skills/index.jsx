        ...
        >
          {skillsData.map((skill, id) => {
            ...
            return (
              <div
                key={id}
                className="w-36 min-w-fit flex flex-col items-center justify-center m-3 sm:m-5 rounded-lg group relative hover:scale-[1.15] transition-all duration-500 cursor-pointer"
              >
